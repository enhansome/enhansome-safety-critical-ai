...
* [`fairlearn/fairlearn`](https://github.com/fairlearn/fairlearn) ⭐ 2,287 | 🐛 125 | 🌐 Python | 📅 2026-09-21: a Python package to assess and improve fairness of ML models
...
* (Linux Foundation) [ONNX Safety-Related Profile](https://github.com/ericjenn/working-groups/tree/ericjenn-srpwg-wg1/safety-related-profile) ⭐ 4 | 🐛 88 | 🌐 Jupyter Notebook | 📅 2026-09-24
