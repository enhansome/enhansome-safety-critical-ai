...
* 🧰 An awesome set of [tools for production-ready ML](https://github.com/EthicalML/awesome-production-machine-learning) ⭐ 20,839 | 🐛 31 | 📅 2026-08-12
  > **A word of caution** ☝️ Use them wisely and remember that *"a sword is only as good as the man \[or woman] who wields it"*
* 😈 A collection of scary [use cases](https://github.com/daviddao/awful-ai) ⭐ 7,529 | 🐛 24 | 📅 2025-02-20, [incidents](https://incidentdatabase.ai/) and [failures](https://avidml.org/) of AI, which will hopefully raise awareness to its misuses
...
* [Responsible AI](https://github.com/aws-samples/aws-machine-learning-university-responsible-ai) ⭐ 78 | 🐛 10 | 🌐 Jupyter Notebook | 📅 2026-05-14 @ Amazon MLU
...
* [`MISRA-C++/2008`](https://github.com/zaznov/MISRA/blob/main/MISRA%20C%2B%2B%202008.pdf) ⭐ 67 | 🐛 0 | 📅 2021-03-24: Guidelines for the use of the C++ language in critical systems
...
* [`Trusted-AI/adversarial-robustness-toolbox`](https://github.com/Trusted-AI/adversarial-robustness-toolbox) ⭐ 6,171 | 🐛 19 | 🌐 Python | 📅 2025-12-12: a Python library for ML security - evasion, poisoning, extraction, inference - red and blue teams
...
* [`pydantic/pydantic`](https://github.com/pydantic/pydantic) ⭐ 28,531 | 🐛 586 | 🌐 Python | 📅 2026-08-12: data validation using Python type hints
* [`iterative/dvc`](https://github.com/iterative/dvc) ⭐ 15,813 | 🐛 195 | 🌐 Python | 📅 2026-08-10: a command line tool and VS Code Extension to help you develop reproducible ML projects
* [`great-expectations/great_expectations`](https://github.com/great-expectations/great_expectations) ⭐ 11,708 | 🐛 38 | 🌐 Python | 📅 2026-08-13: always know what to expect from your data
* [`cleanlab/cleanlab`](https://github.com/cleanlab/cleanlab) ⭐ 11,624 | 🐛 115 | 🌐 Python | 📅 2026-01-13: data-centric AI package for data quality and ML with messy, real-world data and labels.
* [`unionai-oss/pandera`](https://github.com/unionai-oss/pandera) ⭐ 4,431 | 🐛 449 | 🌐 Python | 📅 2026-08-07: data validation for scientists, engineers, and analysts seeking correctness
* [`facebook/Ax`](https://github.com/facebook/Ax) ⭐ 2,787 | 🐛 186 | 🌐 Python | 📅 2026-08-13: an accessible, general-purpose platform for understanding, managing, deploying, and automating adaptive experiments
* [`tensorflow/data-validation`](https://github.com/tensorflow/data-validation) ⭐ 783 | 🐛 16 | 🌐 Python | 📅 2026-06-11: a library for exploring and validating ML data

### Model Evaluation

* [`confident-ai/deepeval`](https://github.com/confident-ai/deepeval) ⭐ 17,563 | 🐛 450 | 🌐 Python | 📅 2026-08-13: a simple-to-use, open-source LLM evaluation framework, for evaluating and testing LLM systems
...
* [`trust-ai/SafeBench`](https://github.com/trust-ai/SafeBench) ⭐ 155 | 🐛 17 | 🌐 Python | 📅 2024-02-23: a benchmark for evaluating Autonomous Vehicles in safety-critical scenarios
* [`future-agi/ai-evaluation`](https://github.com/future-agi/ai-evaluation) ⭐ 117 | 🐛 7 | 🌐 Python | 📅 2026-08-12: an open-source LLM evaluation framework with 50+ metrics, LLM-as-Judge augmentation, and guardrail scanners (jailbreak, PII, prompt-injection); AutoEval pipelines with CI/CD support

### Model Fairness & Privacy

* [`fairlearn/fairlearn`](https://github.com/fairlearn/fairlearn) ⭐ 2,268 | 🐛 124 | 🌐 Python | 📅 2026-08-12: a Python package to assess and improve fairness of ML models
* [`tensorflow/privacy`](https://github.com/tensorflow/privacy) ⭐ 2,022 | 🐛 136 | 🌐 Python | 📅 2026-07-08: a library for training ML models with privacy for training data
* [`pytorch/opacus`](https://github.com/pytorch/opacus) ⭐ 1,949 | 🐛 81 | 🌐 Python | 📅 2026-07-13: a library that enables training PyTorch models with differential privacy
* [`zama-ai/concrete-ml`](https://github.com/zama-ai/concrete-ml) ⭐ 1,445 | 🐛 22 | 🌐 Python | 📅 2026-08-04: a Privacy-Preserving Machine Learning (PPML) open-source set of tools built on top of Concrete by Zama
* [`Dstack-TEE/dstack`](https://github.com/Dstack-TEE/dstack) ⭐ 526 | 🐛 67 | 🌐 Rust | 📅 2026-08-13: TEE framework for private AI model deployment with hardware-level isolation using Intel TDX and NVIDIA Confidential Computing

### Model Intepretability

* [`pytorch/captum`](https://github.com/pytorch/captum) ⭐ 5,685 | 🐛 66 | 🌐 Python | 📅 2026-08-11: a model interpretability and understanding library for PyTorch
* [`MAIF/shapash`](https://github.com/MAIF/shapash) ⭐ 3,254 | 🐛 46 | 🌐 Jupyter Notebook | 📅 2026-07-28: user-friendly explainability and interpretability to develop reliable and transparent ML models
* [`SeldonIO/alibi`](https://github.com/SeldonIO/alibi) ⭐ 2,643 | 🐛 160 | 🌐 Python | 📅 2025-10-17: a library aimed at ML model inspection and interpretation

### Model Lifecycle

* [`mlflow/mlflow`](https://github.com/mlflow/mlflow) ⭐ 27,490 | 🐛 2,022 | 🌐 Python | 📅 2026-08-13: an open-source platform for the ML lifecycle
* [`comet-ml/opik`](https://github.com/comet-ml/opik) ⭐ 21,342 | 🐛 195 | 🌐 Python | 📅 2026-08-13: an open-source platform for evaluating, testing and monitoring LLM applications
* [`wandb/wandfb`](https://github.com/wandb/wandb) ⭐ 11,231 | 🐛 921 | 🌐 Python | 📅 2026-08-13: a fully-featured AI developer platform
* [`evidentlyai/evidently`](https://github.com/evidentlyai/evidently) ⭐ 7,800 | 🐛 297 | 🌐 Jupyter Notebook | 📅 2026-08-05: an open-source ML and LLM observability framework
* [`aimhubio/aim`](https://github.com/aimhubio/aim) ⭐ 6,230 | 🐛 468 | 🌐 Python | 📅 2026-08-12: an easy-to-use and supercharged open-source experiment tracker
...
* [`nvidia/garak`](https://github.com/NVIDIA/garak) ⭐ 8,786 | 🐛 393 | 🌐 Python | 📅 2026-08-11: Generative AI red-teaming and assessment kit
...
* [`explodinggradients/ragas`](https://github.com/explodinggradients/ragas) ⭐ 15,294 | 🐛 553 | 🌐 Python | 📅 2026-02-24: objective metrics, intelligent test generation, and data-driven insights for LLM apps
* [`deepchecks/deepchecks`](https://github.com/deepchecks/deepchecks) ⭐ 4,041 | 🐛 265 | 🌐 Python | 📅 2025-12-28: an open-source package for validating ML models and data
...
* [`ollama/ollama`](https://github.com/ollama/ollama) ⭐ 178,390 | 🐛 3,668 | 🌐 Go | 📅 2026-08-12: get up and running with Llama 3.3, DeepSeek-R1, Phi-4, Gemma 2, and other large LMs
* [`langgenius/dify`](https://github.com/langgenius/dify) ⭐ 152,277 | 🐛 1,066 | 🌐 TypeScript | 📅 2026-08-13: an open-source LLM app development platform, which combines agentic AI workflow, RAG pipeline, agent capabilities, model management, observability features and more, letting you quickly go from prototype to production
* [`browser-use/browser-use`](https://github.com/browser-use/browser-use) ⭐ 108,991 | 🐛 349 | 🌐 Python | 📅 2026-08-11: make websites accessible for AI agents
* [`hiyouga/LLaMA-Factory`](https://github.com/hiyouga/LLaMA-Factory) ⭐ 74,043 | 🐛 1,111 | 🌐 Python | 📅 2026-08-10: unified efficient fine-tuning of 100+ LLMs and VLMs
* [`unslothai/unsloth`](https://github.com/unslothai/unsloth) ⭐ 70,686 | 🐛 1,107 | 🌐 Python | 📅 2026-08-13: finetune Llama 3.3, DeepSeek-R1 and reasoning LLMs 2x faster with 70% less memory! 🦥
* [`DS4SD/docling`](https://github.com/DS4SD/docling) ⭐ 64,681 | 🐛 961 | 🌐 Python | 📅 2026-08-12: get your documents ready for gen AI
* [`Mintplex-Labs/anything-llm`](https://github.com/Mintplex-Labs/anything-llm) ⭐ 64,667 | 🐛 316 | 🌐 JavaScript | 📅 2026-08-13: all-in-one Desktop & Docker AI application with built-in RAG, AI agents, No-code agent builder, and more
* [`BerriAI/litellm`](https://github.com/BerriAI/litellm) ⭐ 56,212 | 🐛 4,853 | 🌐 Python | 📅 2026-08-13: all LLM APIs using the OpenAI format \[Bedrock, Huggingface, VertexAI, TogetherAI, Azure, OpenAI, Groq, \&c.]
* [`FlowiseAI/Flowise`](https://github.com/FlowiseAI/Flowise) ⭐ 55,362 | 🐛 1,048 | 🌐 TypeScript | 📅 2026-08-10: drag & drop UI to build your customized LLM flow
* [`run-llama/llama_index`](https://github.com/run-llama/llama_index) ⭐ 51,602 | 🐛 601 | 🌐 Python | 📅 2026-08-12: the leading framework for building LLM-powered agents over your data
* [`exo-explore/exo`](https://github.com/exo-explore/exo) ⭐ 46,790 | 🐛 333 | 🌐 Python | 📅 2026-06-23: run your own AI cluster at home with everyday devices 📱💻 🖥️⌚
* [`agno-agi/agno`](https://github.com/agno-agi/agno) ⭐ 41,682 | 🐛 1,228 | 🌐 Python | 📅 2026-08-13: a lightweight library for building multi-modal agents
* [`stanfordnlp/dspy`](https://github.com/stanfordnlp/dspy) ⭐ 37,154 | 🐛 647 | 🌐 Python | 📅 2026-08-12: the framework for programming - not prompting - language models
* [`khoj-ai/khoj`](https://github.com/khoj-ai/khoj) ⭐ 36,470 | 🐛 130 | 🌐 Python | 📅 2026-08-02: a self-hostable AI second brain
* [`ItzCrazyKns/Perplexica`](https://github.com/ItzCrazyKns/Perplexica) ⭐ 36,113 | 🐛 346 | 🌐 TypeScript | 📅 2026-04-11: an AI-powered search engine and open source alternative to Perplexity AI
* [`langfuse/langfuse`](https://github.com/langfuse/langfuse) ⭐ 32,999 | 🐛 759 | 🌐 TypeScript | 📅 2026-08-13: an open source LLM engineering platform with support for LLM observability, metrics, evals, prompt management, playground, datasets
* [`topoteretes/cognee`](https://github.com/topoteretes/cognee) ⭐ 29,982 | 🐛 395 | 🌐 Python | 📅 2026-08-12: reliable LLM memory for AI applications and AI agents
* [`ComposioHQ/composio`](https://github.com/ComposioHQ/composio) ⭐ 29,662 | 🐛 50 | 🌐 TypeScript | 📅 2026-08-13: equip's your AI agents & LLMs with 100+ high-quality integrations via function calling
* [`ScrapeGraphAI/Scrapegraph-ai`](https://github.com/ScrapeGraphAI/Scrapegraph-ai) ⭐ 29,446 | 🐛 15 | 🌐 Python | 📅 2026-07-20: a web scraping python library that uses LLM and direct graph logic to create scraping pipelines for websites and local documents
* [`deepset-ai/haystack`](https://github.com/deepset-ai/haystack) ⭐ 26,189 | 🐛 95 | 🌐 Python | 📅 2026-08-12: orchestration framework to build customizable, production-ready LLM applications
* [`Cinnamon/kotaemon`](https://github.com/Cinnamon/kotaemon) ⭐ 25,695 | 🐛 240 | 🌐 Python | 📅 2026-07-14: an open-source RAG-based tool for chatting with your documents
* [`promptfoo/promptfoo`](https://github.com/promptfoo/promptfoo) ⭐ 24,185 | 🐛 497 | 🌐 TypeScript | 📅 2026-08-13: a developer-friendly local tool for testing LLM applications
* [`guidance-ai/guidance`](https://github.com/guidance-ai/guidance) ⭐ 21,711 | 🐛 318 | 🌐 Jupyter Notebook | 📅 2026-05-21: a guidance language for controlling large language models
* [`pydantic/pydantic-ai`](https://github.com/pydantic/pydantic-ai) ⭐ 19,258 | 🐛 699 | 🌐 Python | 📅 2026-08-13: agent framework / shim to use Pydantic with LLMs
* [`microsoft/data-formulator`](https://github.com/microsoft/data-formulator) ⭐ 16,023 | 🐛 94 | 🌐 Python | 📅 2026-08-12: transform data and create rich visualizations iteratively with AI 🪄
* [`dottxt-ai/outlines`](https://github.com/dottxt-ai/outlines) ⭐ 15,588 | 🐛 141 | 🌐 Python | 📅 2026-08-12: make LLMs speak the language of every application
* [`instructor-ai/instructor`](https://github.com/instructor-ai/instructor) ⭐ 13,724 | 🐛 28 | 🌐 Python | 📅 2026-08-09: the most popular Python library for working with structured outputs from LLMs
* [`keephq/keep`](https://github.com/keephq/keep) ⭐ 12,202 | 🐛 553 | 🌐 Python | 📅 2026-08-08: open-source AIOps and alert management platform
* [`Arize-ai/phoenix`](https://github.com/Arize-ai/phoenix) ⭐ 11,023 | 🐛 916 | 🌐 Python | 📅 2026-08-13: an open-source AI observability platform designed for experimentation, evaluation, and troubleshooting
* [`Giskard-AI/giskard`](https://github.com/Giskard-AI/giskard) ⭐ 5,749 | 🐛 73 | 🌐 Python | 📅 2026-08-13: control risks of performance, bias and security issues in AI systems
* [`h2oai/h2o-llmstudio`](https://github.com/h2oai/h2o-llmstudio) ⭐ 5,160 | 🐛 41 | 🌐 Python | 📅 2026-08-05: a framework and no-code GUI for fine-tuning LLMs
* [`latitude-dev/latitude-llm`](https://github.com/latitude-dev/latitude-llm) ⭐ 4,577 | 🐛 115 | 🌐 TypeScript | 📅 2026-08-13: open-source prompt engineering platform to build, evaluate, and refine your prompts with AI
* [`eth-sri/lmql`](https://github.com/eth-sri/lmql) ⭐ 4,203 | 🐛 120 | 🌐 Python | 📅 2025-05-22: a programming language for LLMs based on a superset of Python
...
* [`microsoft/prompty`](https://github.com/microsoft/prompty) ⭐ 1,248 | 🐛 57 | 🌐 Rust | 📅 2026-08-12: an asset class and format for LLM prompts designed to enhance observability, understandability, and portability for developers
* [`groq/groq-python`](https://github.com/groq/groq-python) ⭐ 613 | 🐛 3 | 🌐 Python | 📅 2026-08-13: the official Python library for the Groq API
...
* [Awful AI](https://github.com/daviddao/awful-ai) ⭐ 7,529 | 🐛 24 | 📅 2025-02-20, a collection of scary AI use cases
...
* [Awesome LLM Apps](https://github.com/Shubhamsaboo/awesome-llm-apps) ⭐ 132,371 | 🐛 9 | 🌐 Python | 📅 2026-08-10: a collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini and opensource models
* [Awesome Production ML](https://github.com/EthicalML/awesome-production-machine-learning) ⭐ 20,839 | 🐛 31 | 📅 2026-08-12: a curated list of awesome open source libraries that will help you deploy, monitor, version, scale, and secure your production machine learning
* [Awesome MLOps](https://github.com/kelvins/awesome-mlops) ⭐ 5,236 | 🐛 73 | 🌐 Python | 📅 2026-04-29: a curated list of awesome MLOps tools
...
* [Awesome Safety Critical](https://github.com/stanislaw/awesome-safety-critical) ⭐ 1,593 | 🐛 0 | 🌐 Python | 📅 2025-03-11: a list of resources about programming practices for writing safety-critical software
* [Awesome Prompt Hacking](https://github.com/PromptLabs/Prompt-Hacking-Resources) ⭐ 669 | 🐛 2 | 📅 2026-07-30: an awesome list of curated resources on prompt hacking and AI safety
...
* [Awesome Responsible AI](https://github.com/AthenaCore/AwesomeResponsibleAI) ⭐ 142 | 🐛 24 | 📅 2026-08-12: a curated list of awesome academic research, books, code of ethics, courses, data sets, frameworks, institutes, maturity models, newsletters, principles, podcasts, reports, tools, regulations and standards related to Responsible, Trustworthy, and Human-Centered AI
